...
If your app already uses Revopush v1.x, please refer to the [migration guide](/revopush20/migration).
...
|------------------------------------|---------------------------------------------|
| 0.76, 0.77, 0.78, 0.79, 0.80, 0.81 | @revopush/react-native-code-push@2.5.0-rc.3 |
...
```bash
npm install --save @revopush/react-native-code-push@2.5.0-rc.3
```
...
```shell
npm i -g @revopush/code-push-cli@0.0.10
```
